            ...
            <div className={styles.container__dialog__footer}>
                <div className={styles.infoBox}>
                    <div className={styles.infoBox__item}>
                        <span className={styles.__item__label}> 이미지 크기 </span>
                        <span className={styles.__item__value}>
                            {data.width} X {data.height}
                        </span>
                    </div>
                    <div className={styles.infoBox__item}>
                        <span className={styles.__item__label}> 업로드 </span>
                        <span className={styles.__item__value}> {data.created_at.split('T')[0]} </span>
                    </div>
                    <div className={styles.infoBox__item}>
                        <span className={styles.__item__label}> 마지막 업데이트 </span>
                        <span className={styles.__item__value}> {data.updated_at.split('T')[0]} </span>
                    </div>
                    <div className={styles.infoBox__item}>
                        <span className={styles.__item__label}> 다운로드 </span>
                        <span className={styles.__item__value}> {data.likes} </span>
                    </div>
